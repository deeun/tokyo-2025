          ...
          isClient ?
              <div className={'main__wrap'}>
                  ...
                  <div className={styles.section__wrap}>
                      ...
                      <div>
                          <div className={'mg-top-20'}>
                              <div className={'bold'} onClick={() => setTokyoHotelShow(!tokyoHotelShow)}>
                          ...
                          <div className={'mg-top-20'}>
                              <div className={'bold'} onClick={() => setYokoHotelShow(!yokoHotelShow)}>
                              <span>{yokoHotelShow ? '▼ ' : '▶︎ '}︎</span>요코하마 (1박)</div>
                              { yokoHotelShow &&
                                  <div>
                  ...
                  <div className={styles.section__wrap}>
                      <div className={'bold'}>📅 일정 요약</div>
                      <div className='mg-top-20'>
                          <div>▶︎ Day 1 긴자 & 도쿄역</div>
                          <div>▶︎ Day 2 신주쿠 & 오모테산도</div>
                          <div>▶︎ Day 3 카피바라 & 아자부다이</div>
                          <div>▶︎ Day 4 요코하마</div>
                          <div>▶︎ Day 5 요코하마</div>
                      </div>
